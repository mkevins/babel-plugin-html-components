  ...
  render() {
    ...
    return <Figure className={className}>
				...
				<Div className="block-library-gallery-item__move-menu">
					...
					<IconButton icon="arrow-right" onClick={isLastItem ? undefined : onMoveForward} className="blocks-gallery-item__move-forward" label={__('Move Image Forward')} aria-disabled={isLastItem} disabled={!isSelected} />
				</Div>
				<Div className="block-library-gallery-item__inline-menu">
					<IconButton icon="no-alt" onClick={onRemove} className="blocks-gallery-item__remove" label={__('Remove Image')} disabled={!isSelected} />
				</Div>
